...
struct KVView: View {
    ...
    var body: some View {
        ...
        ResourceScreen(title: "KV Namespaces", systemImage: "tablecells", itemNoun: "namespace", accent: Color(hex: 0x2AA79B), createKind: .kv) {
...
struct D1View: View {
    ...
    var body: some View {
        ...
        ResourceScreen(title: "D1 Databases", systemImage: "cylinder.split.1x2", itemNoun: "database", accent: Color(hex: 0x7C5CFC), createKind: .d1) {
...
struct R2View: View {
    ...
    var body: some View {
        ...
        ResourceScreen(title: "R2 Buckets", systemImage: "externaldrive", itemNoun: "bucket", accent: Color(hex: 0xF6821F), createKind: .r2) {
...
struct QueuesView: View {
    ...
    var body: some View {
        ...
        ResourceScreen(title: "Queues", systemImage: "tray.full", itemNoun: "queue", accent: Color(hex: 0x3A7BD5), createKind: .queue) {
